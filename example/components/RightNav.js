const isBrowser = require('material-ui/lib/utils/is-browser');

let Modernizr = isBrowser ? require('material-ui/lib/utils/modernizr.custom') : undefined;

const React = require('react');
const ReactDOM = require('react-dom');
const KeyCode = require('material-ui/lib/utils/key-code');
...
const Overlay = require('material-ui/lib/overlay');
  ...
  getStyles() {
    ...
    let styles = {
      root: {
        ...
        position: 'fixed',
        zIndex: 10,
        right: isBrowser && Modernizr.csstransforms3d ? 0 : x,
        top: 0,
        transform: 'translate3d(0, 0, 0,'+x+'px)',
